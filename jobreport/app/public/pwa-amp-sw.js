const CACHE_VERSION = '1.7.32.2';

const BASE_CACHE_FILES = [
    'https://jobreport.local/wp-content/uploads/2021/05/JR-logo-cropped-192x192-1.png',
'https://jobreport.local/wp-content/uploads/2021/05/JR-logo-cropped-512x512-1.png',

];

const OFFLINE_CACHE_FILES = [
     'https://jobreport.local/?amp=1',
];
...
const OFFLINE_PAGE = 'https://jobreport.local/?amp=1';
const NOT_FOUND_PAGE = 'https://jobreport.local/?amp=1';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://jobreport.local//wp-admin/');
//    },
];
